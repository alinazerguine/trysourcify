...
$thumbnail_size = royal_option( 'product__thumbnailSize' );
...
if ( $attachment_ids && has_post_thumbnail() ) {
	foreach ( $attachment_ids as $attachment_id ) {
		...
		$thumbnail       = royal_get_image_resized( array(
			'image_id' => $attachment_id,
			'size'     => royal_option( 'product__thumbnailSize' ),
			'crop'     => royal_option( 'product__thumbnailSizeCrop' )
		) );
		...
		$image = royal_get_image_resized( array(
			...
			'crop'     => royal_option( 'product__imageSizeCrop' ),
			'atts'     => $attributes
		) );
