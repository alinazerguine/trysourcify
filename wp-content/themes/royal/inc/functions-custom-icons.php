...
add_filter( 'line/iconpicker_params', function( $params ) {
	$params[] = array(
		'type'        => 'iconpicker',
		'heading'     => __( 'Icon', 'royal' ),
		'param_name'  => 'icon_etline',
		'value'       => '', // default value to backend editor admin_label
		'description' => __( 'Select icon from library.', 'royal' ),
		'settings'    => array(
			'emptyIcon'    => false,
			'type'         => 'etline',
			'iconsPerPage' => 4000
...
add_filter( 'line/iconpicker_types_dropdown', function( $types ) {
	$types[esc_html__( 'Elegent Theme LineIcons', 'royal' )] = 'etline';
	$types[esc_html__( 'Simple Line Icons', 'royal' )] = 'simpleline';
