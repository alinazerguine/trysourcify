 ...
 * @return  void
 */
function royal_define_style( $selector, array $attributes ) {
...
function royal_scheme_styles() {
	global $wp_filesystem;
	
	if ( royal_initialize_filesystem_api() ) {
		$content = $wp_filesystem->get_contents( ROYAL_PATH . 'assets/less/_color.less' );
		$colors  = royal_option( 'global__typography__scheme' );
 ...
 * @return  array
 */
function royal_typography_styles( array $options ) {
	$styles = array();

	if ( isset( $options['family'] ) && $family = royal_parse_font( $options['family'] ) ) {
...
function royal_parse_font( $font, $enqueue = true ) {
 ...
 * @return  array
 */
function royal_background_styles( $options ) {
	$styles = array();
 ...
 * @return  array
 */
function royal_border_styles( $options ) {
 ...
 * @return  string
 */
function royal_color_to_rgba( $color, $alpha ) {
