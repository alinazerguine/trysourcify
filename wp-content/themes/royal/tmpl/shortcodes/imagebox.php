...
$atts = shortcode_atts( array(
	...
	'target'      => '',
	'show_button' => 'no',
	'button_text' => __( 'Continue', 'royal' )
), $atts );

// Preparing the shortcode attributes
$atts['show_button'] = $atts['show_button'] == 'yes';
$atts['button_text'] = empty( $atts['button_text'] ) ? __( 'Continue', 'royal' ) : $atts['button_text'];
	...
	<div class="box-wrapper">
		<div class="box-header">
			...
			<?php if ( ! empty( $atts['subtitle'] ) ): ?>
				<h6 class="box-subtitle"><?php echo wp_kses_post( $atts['subtitle'] ) ?></h6>
			<?php endif ?>
		</div>
			...
			<?php if ( ! empty( $content ) ): ?>
				<div class="box-desc">
					...
					<div class="box-button">
						<a class="button" href="<?php echo esc_url( $atts['link'] ) ?>" target="<?php echo esc_attr( $atts['target'] ) ?>">
